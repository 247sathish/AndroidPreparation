package com.androidpreparation.network.parsejsonretrofit.simpleJSON

import android.os.Bundle
import android.util.Log
import androidx.appcompat.app.AppCompatActivity
import com.androidpreparation.databinding.ActivitySimpleJsonBinding
...
class SimpleJSONActivity : AppCompatActivity() {
    ...
    private fun parseJSON() {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            Log.d("sHI :", service.getEmployee().toString())
